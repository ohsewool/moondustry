...
- **가공 사슬**: 위험 지대의 **티타늄**(파란 광석) + 구리 → **제련소** → **합금** — 코어에 고가 판매하거나 최상위 포탑 **스펙터**의 전용 탄약으로
...
- `ITEM_VALUE`(코어 납품가: 구리 10 / 티타늄 25 / 합금 60) / `AMMO_PER`(구리 6발, 합금 10발) / `AMMO_MAX`(30)
- `AMMO_KIND` — 포탑별 탄약 종류 (스펙터만 합금) / `SMELT_TIME`(제련 2초, 구리1+티탄1→합금1)
